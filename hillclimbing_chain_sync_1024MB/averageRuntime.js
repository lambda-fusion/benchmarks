...
const config1_Raw = fs.readFileSync(
  "./configurations_hillclimbing_chain_sync_1024MB_1.json"
);
const config2_Raw = fs.readFileSync(
  "./configurations_hillclimbing_chain_sync_1024MB_2.json"
);
const config3_Raw = fs.readFileSync(
  "./configurations_hillclimbing_chain_sync_1024MB_3.json"
);
