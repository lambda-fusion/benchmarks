...
const config1_Raw = fs.readFileSync(
  "./configurations_hillclimbing_parallel_sync_320MB_1.json"
);
const config2_Raw = fs.readFileSync(
  "./configurations_hillclimbing_parallel_sync_320MB_2.json"
);
const config3_Raw = fs.readFileSync(
  "./configurations_hillclimbing_parallel_sync_320MB_3.json"
);
